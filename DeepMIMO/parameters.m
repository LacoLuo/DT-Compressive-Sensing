...
params.scenario = 'Boston5G_3p5_nofoliage_shifted_1';          % The adopted ray tracing scenario [check the available scenarios at https://deepmimo.net/scenarios/]
...
% System parameters
params.bandwidth = 30e3/1e9;          % The bandwidth in GHz
